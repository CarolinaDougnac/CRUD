...
class RecepcionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('recepcion.index', compact('proveedores'))
    ...
    public function create()
    {
        ...
        return view('recepcion.create', compact('proveedore'));
    }
    ...
    public function show($id)
    {
        ...
        return view('recepcion.show', compact('proveedore'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('recepcion.edit', compact('proveedore'));
    }
